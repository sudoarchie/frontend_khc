...
export function CardTwo({ title, discription, image, url }: cardData) {
  return (
    <Link
      className="flex flex-col w-[300px] group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg focus:outline-none focus:shadow-lg transition "
      href={url}
    >
